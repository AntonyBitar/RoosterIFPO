...
class PrintQuotationData extends StatefulWidget {
  const PrintQuotationData({
    ...
    required this.header, required this.termsAndConditions,
  });
...
class _PrintQuotationDataState extends State<PrintQuotationData> {
  ...
  Future<Uint8List> _generatePdf(
    ...
    bool hasDiscount = widget.itemsInfoPrint.any((item) =>double.parse('${item['item_discount']}') != 0);
          ...
          children: [
            pw.Row(
              ...
              children: [
                ...
                hasDiscount? reusableShowInfoCard(
                    ...
                    ? pw.Padding(
                      ...
                      child: pw.Column(
                        ...
                        children: [
                          ...
                          gapH6,
                          // if (widget.termsAndConditions != '')//to be use again
                          // pw.Padding(
