 ...
 List<Entry> data = <Entry>[
  Entry('sales_and_clients', "assets/images/clientsIcon.png", <Entry>[
    Entry(
      ...
      <Entry>[Entry('accounts', ''), Entry("add_new_client", '')],
    ),
    Entry(
      'quotation',
      '',
      //"assets/images/quotationIcon.png",
      <Entry>[Entry('new_quotation', ''), Entry('quotation_summary', '')],
    ),
    Entry(
      'sales_order',
      '',
      //"assets/images/clientOrderIcon.png",
      <Entry>[Entry('new_sales_order', ""), Entry('sales_order_summary', "")],
    ),
    Entry(
      'sales_invoice',
      '',
      ...
      <Entry>[
        Entry('new_sales_invoice', ""),
        Entry('sales_invoice_summary', ""),
      ],
    ),
    Entry(
      'return_from_client',
      ...
      <Entry>[
        Entry('return_from_client', ""),
        Entry('return_from_client_summary', ""),
      ],
    ),
    Entry('delivery', "", <Entry>[
      Entry('new_delivery', ""),
      Entry('deliveries_summary', ""),
    ]),
    Entry('pending_docs', "", <Entry>[
      Entry('pending_quotation', ""),
      Entry('to_sales_order', ""),
      Entry('to_invoice', ""),
      Entry('to_deliver', ""),
    ]),
  ]),
  Entry('purchases_and_suppliers', "assets/images/suppliers.png", <Entry>[
    Entry(
      'suppliers',
      '',
  ...
  Entry('inventory_management', "assets/images/inventoryIcon.png", <Entry>[
    ...
    Entry(
      ...
      <Entry>[Entry('transfers', ''), Entry('transfer_out', '')],
    ),
    Entry(
      "replenishment",
      '',
      //"assets/images/transfer.png",
      <Entry>[Entry('replenishment', ''), Entry('replenish_transfer', '')],
    ),
    Entry('physical_inventory', ""),
    Entry('counting_form', ""),
  ]),
  // Entry(
  //   'quotation',
  ...
  //   ],
  // ),
  Entry('stock', "assets/images/stockIcon.png", <Entry>[
    Entry('items', ''),
    Entry('combo', '', <Entry>[
      Entry('create_combo', ''),
      Entry('combo_summary', ''),
  ...
  //   ],
  // ),
  Entry('dashboard_summary', "assets/images/dashboardIcon.png", <Entry>[
  ...
  //   ],
  // ),
  Entry('account_settings', "assets/images/settingsIcon.png", <Entry>[
    Entry('users', "", <Entry>[
      // Entry('create_users', ''),
      Entry('users', ''),
      Entry('roles', ''),
  ...
  Entry('pos_reports', "assets/images/clientOrderIcon.png", <Entry>[
    Entry('sessions_details', ""),
    Entry('daily_qty_report', ""),
    Entry('cash_tray_report', ""),
  ]),
            ...
            showDialog<String>(
              ...
              builder:
                  (BuildContext context) => AlertDialog(
                    ...
                    content:
                        widget.idDesktop
                            ? const CreateProductDialogContent()
            ...
            showDialog<String>(
              ...
              builder:
                  (BuildContext context) => AlertDialog(
                    ...
                    content:
                        widget.idDesktop
                            ? const Combo(isCombosPageIsLastPage: true)
                            : const MobileCreateProductDialogContent(),
                  ),
            );
          }
                ...
                ? Container(
                  width:
                      isCollapsed
                          ? widget.minWidth - 15
                          : widget.maxWidth -
                              15, //MediaQuery.of(context).size.width * 0.035,
                  // height: 200,
                  color: Primary.primary,
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.center,
                                ...
                                return MouseRegion(
                                  onEnter: (event) {
                                    final overlayPosition =
                                        event.position; // Get hover position
                                    showMainMenu(
                                      context,
                                      overlayPosition,
                                      entry.children,
                ...
                : Container(
                  width:
                      isCollapsed
                          ? widget.minWidth - 15
                          : widget.maxWidth -
                              15, // MediaQuery.of(context).size.width * 0.2,
                  // height: 200,
                  color: Primary.primary,
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.start,
