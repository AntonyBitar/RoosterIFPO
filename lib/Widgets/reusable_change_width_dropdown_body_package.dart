...
class DropdownMenusEntry<T> {
  ...
  ///
  /// The default value is true. If true, the [DropdownMenusEntry.label] will be filled
...
///
/// The menu is composed of a list of [DropdownMenusEntry]s. People can provide information,
...
/// * [DropdownMenusEntry], which is used to build the [MenuItemButton] in the [DropdownMenu] list.
class DropdownMenus<T> extends StatefulWidget {
  ...
  /// Descriptions of the menu items in the [DropdownMenus].
  ///
  /// This is a required parameter. It is recommended that at least one [DropdownMenusEntry]
  ...
  /// by the width of menu items or [DropdownMenus.width]. If this property is not null,
  ...
  /// DropdownMenu<Text>(
  ///   enableFilter: true,
  ///   filterCallback: (List<DropdownMenusEntry<Text>> entries, String filter) {
  ...
  ///
  ///       return entries
  ///         .where((DropdownMenusEntry<Text> entry) =>
  ///           entry.label.toLowerCase().contains(trimmedFilter),
  ///         )
  ///         .toList();
  ///   },
  ///   dropdownMenuEntries: const <DropdownMenusEntry<Text>>[],
  /// )
  /// ```
  /// {@end-tool}
  ///
  ...
  /// ```dart
  /// DropdownMenu<Text>(
  ///   searchCallback: (List<DropdownMenusEntry<Text>> entries, String query) {
  ///     if (query.isEmpty) {
  ///       return null;
  ///     }
  ///     final int index = entries.indexWhere((DropdownMenusEntry<Text> entry) => entry.label == query);
  ///
  ...
  /// {@end-tool}
  ///
  /// Defaults to null. If this is null and [DropdownMenus.enableSearch] is true,
...
class _DropdownMenusState<T> extends State<DropdownMenus<T>> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.width != null) {
      effectiveMenuStyle = effectiveMenuStyle.copyWith(minimumSize: WidgetStatePropertyAll<Size?>(Size(1000, 0.0)));
